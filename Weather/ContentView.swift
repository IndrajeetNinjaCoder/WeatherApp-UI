...
struct ContentView: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack{
                CityTextView(cityName: "Noida, India")
                ...
                Button{
                    ...
                    WeatherButton(title: isNight ? "Light Mode": "Dark Mode", textColor: .white, backgroundColor: isNight ? .orange : .gray)
                }
